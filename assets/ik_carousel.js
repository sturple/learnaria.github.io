;(function ( $, window, document, undefined ) {
	...
	Plugin.prototype.init = function () {
		...
		$elem
            ...
            .on('focusin', {'plugin' : plugin}, plugin.focusin)
            .on('focusout', {'plugin' : plugin}, plugin.focusin)
    ...
    */
    ...
    Plugin.prototype.focusin = function (event) {
        var plugin = event.data.plugin;
        plugin.stopTimer(event);
    }
    Plugin.prototype.focusout = function (event) {
        var plugin = event.data.plugin;
